...
{
    public partial class AddEditInvoiceItemForm : Form
    {
        ...
        public AddEditInvoiceItemForm(NpgsqlConnection conn, int id, bool incoming, bool editMode = false, int existingItemId = 0)
        {
            InitializeComponent();
            connection = conn;
            invoiceId = id;
